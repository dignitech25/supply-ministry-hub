    ...
    <div className="min-h-screen bg-cream text-ink">
      ...
      <main className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-fraunces font-light text-ink mb-10">
            Terms & <span className="italic text-gold">conditions</span>
          </h1>
          
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-fraunces font-light text-ink mb-4">General Terms</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-fraunces font-light text-ink mb-4">Products & Services</h2>
              <p className="text-muted-body mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-fraunces font-light text-ink mb-4">Pricing & Payment</h2>
              <p className="text-muted-body mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-fraunces font-light text-ink mb-4">Delivery & Returns</h2>
              <p className="text-muted-body mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-fraunces font-light text-ink mb-4">Privacy Policy</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-fraunces font-light text-ink mb-4">Liability</h2>
              <p className="text-muted-body mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-fraunces font-light text-ink mb-4">Contact Information</h2>
