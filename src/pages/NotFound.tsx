...
const NotFound = () => {
  ...
  return (
    <div className="min-h-screen bg-violet text-cream flex flex-col">
      <SEO 
      ...
      <div className="flex-1 flex items-center justify-center px-6">
        <div className="text-center max-w-lg">
          <p className="font-geist text-[11px] tracking-[0.18em] uppercase text-cream/60 mb-4">404</p>
          ...
          <p className="text-lg text-cream/75 mb-8">
            The page you're looking for has moved, been renamed, or never existed.
          </p>
          <Link
            to="/"
            className="inline-block bg-cream text-violet hover:opacity-90 transition-opacity rounded-full px-8 py-3 font-geist text-sm"
          >
            Return home
          </Link>
        </div>
