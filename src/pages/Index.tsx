      ...
      <main id="main-content">
          ...
          <section id="sleep-choice" className="py-20 bg-cream">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <h2 className="font-instrument font-normal text-4xl md:text-5xl text-ink mb-6">Sleep <span className="italic text-gold">Choice</span></h2>
                ...
                <div className="bg-cream-alt rounded-xl p-8 border border-cream-border mb-8">
                  <h3 className="font-instrument font-normal text-2xl text-ink mb-6">How It Works</h3>
                  <div className="grid md:grid-cols-3 gap-6 text-left">
                    <div>
                      <div className="bg-ink text-cream rounded-full w-8 h-8 flex items-center justify-center mb-3 font-medium">1</div>
                      <h4 className="font-instrument text-lg text-ink mb-2">Choose Your Solution</h4>
                    ...
                    <div>
                      ...
                      <h4 className="font-instrument text-lg text-ink mb-2">7-Day Trial</h4>
                    ...
                    <div>
                      ...
                      <h4 className="font-instrument text-lg text-ink mb-2">Keep or Return</h4>
          ...
          <section id="testimonials" className="py-20 bg-cream-alt">
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                ...
                <h2 className="font-instrument font-normal text-4xl md:text-5xl text-ink mb-4">What our clients <span className="italic text-gold">say</span></h2>
                  ...
                  <AnimatedSection key={index} delay={index * 0.15}>
                    ...
                    >
                      ...
                      <div className="relative">
                        <span className="absolute -top-2 -left-2 text-5xl text-gold/30 font-instrument">"</span>
                      ...
                      <div className="mt-4 pt-4 border-t border-cream-border">
                        <p className="font-instrument text-ink">{testimonial.company}</p>
        ...
        <section id="contact" className="py-24 bg-ink text-cream relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            <h2 className="font-instrument font-normal text-4xl md:text-5xl mb-5">Ready to get <span className="italic text-gold">started</span>?</h2>
            ...
            <div className="grid sm:grid-cols-2 gap-8 max-w-md mx-auto text-center">
              <div>
                <p className="font-instrument text-xl mb-2">Alex</p>
                ...
                <a href="tel:+61452002450" className="block text-2xl font-instrument tracking-tight hover:text-gold transition-colors">0452 002 450</a>
              </div>
              <div>
                <p className="font-instrument text-xl mb-2">David</p>
                ...
                <a href="tel:+61404593090" className="block text-2xl font-instrument tracking-tight hover:text-gold transition-colors">0404 593 090</a>
              </div>
            </div>
