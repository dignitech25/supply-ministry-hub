  ...
  return (
    <div className="min-h-screen bg-cream text-ink">
                ...
                <Card key={index} className="bg-cream-alt border-cream-border">
                  <CardHeader>
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <CardTitle className="text-xl font-geist font-light tracking-tight leading-[1.05] text-ink">{resource.title}</CardTitle>
                    </div>
      ...
      <section id="blog" className="py-20 bg-cream-alt">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-geist font-light tracking-tight leading-[1.05] text-ink mb-4">Supply Line blog</h2>
      ...
      <section id="ndis" className="py-20 bg-cream-alt">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-geist font-light tracking-tight leading-[1.05] text-ink mb-4">NDIS funding information</h2>
            <p className="text-lg text-muted-body max-w-2xl mx-auto">
          ...
          <div className="max-w-5xl mx-auto">
            {/* Funding Categories */}
            <div className="mb-12">
              <h3 className="text-2xl font-geist font-light tracking-tight leading-[1.05] text-ink mb-6">NDIS funding categories</h3>
              <div className="grid md:grid-cols-3 gap-6">
                {ndisInfo.fundingCategories.map((category, index) => (
                  <Card key={index} className="bg-cream border-cream-border">
                    <CardHeader>
                      <CardTitle className="text-lg font-geist font-light tracking-tight leading-[1.05] text-ink">{category.title}</CardTitle>
            ...
            <div className="bg-cream rounded-xl p-8 border border-cream-border">
              <h3 className="text-2xl font-geist font-light tracking-tight leading-[1.05] text-ink mb-6 text-center">
