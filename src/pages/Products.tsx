    ...
    <div className="min-h-screen bg-violet text-cream">
      ...
      <main className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-geist font-light tracking-tight leading-[1.05] text-ink mb-3 leading-[1.1]">
        ...
        <div className="w-full">
            ...
            {loading ? (
              ...
              <div className="text-center py-16 bg-cream-alt rounded-xl border border-cream-border">
                ...
                <h3 className="text-xl font-geist font-light tracking-tight leading-[1.05] text-ink mb-2">No products found</h3>
