      ...
      <main className="flex-1">
        ...
        <section className="bg-cream py-16 md:py-24">
          <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
            ...
            <h1 className="text-3xl md:text-5xl font-fraunces font-light leading-[1.1] mb-5 text-ink">
        ...
        <section className="py-14 md:py-20">
          <div className="max-w-3xl mx-auto px-6 lg:px-8">
            <h2 className="text-2xl md:text-3xl font-fraunces font-light text-ink mb-6">
        ...
        <section className="py-14 md:py-20 bg-cream-alt">
          <div className="max-w-3xl mx-auto px-6 lg:px-8">
            <h2 className="text-2xl md:text-3xl font-fraunces font-light text-ink mb-10 text-center">
              How it works
            </h2>
        ...
        <section className="py-14 md:py-20">
          <div className="max-w-3xl mx-auto px-6 lg:px-8">
            <h2 className="text-2xl md:text-3xl font-fraunces font-light text-ink mb-8">
              Common questions
            </h2>
        ...
        <section className="py-16 md:py-24 bg-ink text-cream">
          <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
            <h2 className="text-3xl md:text-4xl font-fraunces font-light mb-4">
