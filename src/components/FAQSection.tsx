      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="font-instrument font-normal text-4xl md:text-5xl text-ink mb-4">Frequently asked <span className="italic text-gold">questions</span></h2>
          ...
          <Accordion type="single" collapsible className="w-full">
            {faqs.map((faq, index) => (
              <AccordionItem key={index} value={`item-${index}`} className="border-cream-border">
                <AccordionTrigger className="text-left text-base font-instrument text-ink hover:text-ink">
                  {faq.question}
                </AccordionTrigger>
