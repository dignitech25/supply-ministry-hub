...
ADD COLUMN IF NOT EXISTS requester_organisation text,
ADD COLUMN IF NOT EXISTS requester_email text,
ADD COLUMN IF NOT EXISTS requester_phone text,
ADD COLUMN IF NOT EXISTS client_name text,
ADD COLUMN IF NOT EXISTS client_ndis_number text,
ADD COLUMN IF NOT EXISTS delivery_address text,
ADD COLUMN IF NOT EXISTS clinical_context text,
ADD COLUMN IF NOT EXISTS urgency text,
ADD COLUMN IF NOT EXISTS subtotal numeric,
ADD COLUMN IF NOT EXISTS raw_form jsonb;

-- Update existing ref_code default if needed
ALTER TABLE public.quotes ALTER COLUMN ref_code SET DEFAULT public.make_quote_number();
